...
train_loader = DataLoader(graphs_train, batch_size=64, shuffle=True)
val_loader   = DataLoader(graphs_val,   batch_size=64)
...
model_path = f'cgcnn_vglobalattention_ICSD_c{args.c}_hd{args.hd}_m{args.m}_exp_split_final_unweighted.pt'
...
print("\n--- Test ---")
print("Loading graphs...")
#graphs_test = torch.load('graphs/crystal_graphs_vClaude_MP_exp.pt', weights_only=False)
...
fig.tight_layout()
plt.savefig(f'plots/cgcnn_vglobalattention_ICSD_c{args.c}_hd{args.hd}_m{args.m}__split_final_unweighted_results.png', dpi=300)
plt.show()