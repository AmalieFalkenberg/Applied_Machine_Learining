...
model_path = f'cgcnn_vClaude_ICSD_c{args.c}_hd{args.hd}_m{args.m}_exp_split_final_unweighted.pt'
...
fig.tight_layout()
plt.savefig(f'plots/cgcnn_vClaude_ICSD_c{args.c}_hd{args.hd}_m{args.m}__split_final_unweighted_results.png', dpi=300)
plt.show()