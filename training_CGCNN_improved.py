...
if True:
    ...
    torch.save(model.state_dict(), f'cgcnn_vClaude_ICSD_c{4}_hd{128}_m{3}_exp_split_final_unweighted.pt')
...
if False:
    ...
    torch.save(model.state_dict(), f'cgcnn_vClaude_ICSD_c{3}_hd{128}_m{3}_exp_final.pt')
